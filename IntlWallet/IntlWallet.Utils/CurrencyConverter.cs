...
namespace IntlWallet.Utils
{
    public static class CurrencyConverter
    {
        ...
        {
            if (!ValidateCurrencyInput(mainCurrency) || !ValidateCurrencyInput(mainCurrency))
                throw new ArgumentException("Invalid currency input");
        ...
        public static bool ValidateCurrencyInput(string currency)
        {
